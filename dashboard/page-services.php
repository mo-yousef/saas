                        ...
                        <div class="mobooking-card service-card" data-service-id="<?php echo esc_attr($service['service_id']); ?>">
                            <div class="mobooking-card-header">
                                ...
                                <div class="mobooking-card-actions">
                                     <span class="badge status-<?php echo esc_attr($service['status']); ?>"><?php echo esc_html(ucfirst($service['status'])); ?></span>
                                     <a href="<?php echo esc_url(site_url('/dashboard/service-edit/?service_id=' . $service['service_id'])); ?>" class="btn btn-icon btn-sm">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg>
                                     </a>
                                    <button class="btn btn-icon btn-sm btn-destructive mobooking-delete-service-btn" data-id="<?php echo esc_attr($service['service_id']); ?>">
...
<!-- Service Card Template is now rendered via PHP -->