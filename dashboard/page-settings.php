        ...
        <div id="mobooking-bizinfo-tab" class="mobooking-settings-tab-content">
            ...
            <table class="form-table">
                <tr valign="top">
                    ...
                    <td><input name="biz_name" type="text" id="biz_name" class="regular-text">
                ...
                <tr valign="top">
                    ...
                    <td><input name="biz_email" type="email" id="biz_email" class="regular-text">
                ...
                <tr valign="top">
                    ...
                    <td><input name="biz_phone" type="tel" id="biz_phone" class="regular-text"></td>
                </tr>
                <tr valign="top">
                    <th scope="row"><label for="biz_address"><?php esc_html_e('Business Address', 'mobooking'); ?></label></th>
                    <td><textarea name="biz_address" id="biz_address" class="large-text" rows="4"></textarea>
                ...
                <tr valign="top">
                    ...
                    <td><input name="biz_logo_url" type="url" id="biz_logo_url" class="large-text" placeholder="https://example.com/logo.png">
                ...
                <tr valign="top">
                    ...
                    <td><input name="biz_currency_symbol" type="text" id="biz_currency_symbol" class="small-text" value="$" maxlength="5">
                ...
                <tr valign="top">
                    ...
                    <td>
                        <select name="biz_currency_position" id="biz_currency_position">
                            <option value="before"><?php esc_html_e('Before amount (e.g., $100)', 'mobooking'); ?></option>
                            <option value="after"><?php esc_html_e('After amount (e.g., 100$)', 'mobooking'); ?></option>
                        </select>
        ...
        <div id="mobooking-emailconf-tab" class="mobooking-settings-tab-content" style="display:none;">
            ...
            <table class="form-table">
                <tr valign="top">
                    ...
                    <td><input name="email_from_name" type="text" id="email_from_name" class="regular-text">
                ...
                <tr valign="top">
                    ...
                    <td><input name="email_from_address" type="email" id="email_from_address" class="regular-text">
            ...
            <table class="form-table">
                <tr valign="top">
                    ...
                    <td><input name="email_booking_conf_subj_customer" type="text" id="email_booking_conf_subj_customer" class="large-text"></td>
                </tr>
                <tr valign="top">
                    <th scope="row"><label for="email_booking_conf_body_customer"><?php esc_html_e('Body', 'mobooking'); ?></label></th>
                    <td><textarea name="email_booking_conf_body_customer" id="email_booking_conf_body_customer" class="large-text code" rows="10" style="font-family: monospace;"></textarea>
            ...
            <table class="form-table">
                <tr valign="top">
                    ...
                    <td><input name="email_booking_conf_subj_admin" type="text" id="email_booking_conf_subj_admin" class="large-text"></td>
                </tr>
                <tr valign="top">
                    <th scope="row"><label for="email_booking_conf_body_admin"><?php esc_html_e('Body', 'mobooking'); ?></label></th>
                    <td><textarea name="email_booking_conf_body_admin" id="email_booking_conf_body_admin" class="large-text code" rows="10" style="font-family: monospace;"></textarea>
        ...
        <div id="mobooking-bizhours-tab" class="mobooking-settings-tab-content" style="display:none;">
            ...
            <table class="form-table">
                <tr valign="top">
                    ...
                    <td>
                        <textarea name="biz_hours_json" id="biz_hours_json" class="large-text code" rows="12" style="font-family: monospace;"></textarea>
                        <p class="description">
