            ...
            <main id="main" class="site-main">
                <div id="mobooking-register-form-container" class="mobooking-auth-form-wrapper">
                    ...
                    <form id="mobooking-register-form">
                        ...
                        <h3><?php esc_html_e( 'Personal Information', 'mobooking' ); ?></h3>
                        <div class="form-row">
                        ...
                        <?php if ( !$is_invitation ): ?>
                            <h3 style="margin-top: 2rem;"><?php esc_html_e( 'Business Information', 'mobooking' ); ?></h3>
                            <p class="register-company-name">
                                <label for="mobooking-company-name"><?php esc_html_e( 'Company Name', 'mobooking' ); ?></label>
                                <input type="text" name="company_name" id="mobooking-company-name" class="input" value="" />
                                <small><?php esc_html_e( 'This will be used to generate your unique business URL (slug).', 'mobooking' ); ?></small>
                            </p>
                        <?php else: ?>
                            <input type="hidden" name="company_name" id="mobooking-company-name" value="" />
                        <?php endif; ?>

                        <!-- Placeholder for reCAPTCHA -->
                        <div id="mobooking-recaptcha-container" style="margin-top: 1rem;"></div>
