...
class UserManagementPage {
    ...
    public static function render_main_page_content() {
        ...
        <div class="wrap">
            ...
            <table class="wp-list-table widefat fixed striped table-view-list business-owners">
                <thead>
                    <tr>
    ...
    public static function render_user_management_page_content() {
        ...
        <div class="wrap">
            ...
            <h2 class="nav-tab-wrapper">
                <a href="#user-hierarchy" class="nav-tab nav-tab-active"><?php _e('User Hierarchy', 'nordbooking'); ?></a>
                <a href="#create-worker" class="nav-tab"><?php _e('Create New Worker', 'nordbooking'); ?></a>
            </h2>

            <div id="user-hierarchy" class="tab-content">
                ...
                $business_owners_list = self::get_business_owners();
                ?>
            ...
            <div id="create-worker" class="tab-content">
