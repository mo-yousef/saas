...
if ( is_page_template('templates/booking-form-modern.php') || $page_type_for_scripts === 'public_booking' || $page_type_for_scripts === 'embed_booking' ) {
    ...
    wp_enqueue_script('mobooking-booking-form', MOBOOKING_THEME_URI . 'assets/js/booking-form.js', array('jquery', 'flatpickr'), MOBOOKING_VERSION, true); // Enqueue new script
