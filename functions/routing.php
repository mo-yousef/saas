...
if ($current_page_slug === 'booking-form') {
    ...
    if ($current_page_slug === 'settings') {
        wp_enqueue_script(
            'NORDBOOKING-dashboard-business-settings',
            NORDBOOKING_THEME_URI . 'assets/js/dashboard-business-settings.js',
            array('jquery'),
            NORDBOOKING_VERSION,
            true
        );
        $biz_settings_params = array_merge($dashboard_params, [
            'i18n' => [
                'saving' => __('Saving...', 'NORDBOOKING'),
                'save_success' => __('Business settings saved successfully.', 'NORDBOOKING'),
                'error_saving' => __('Error saving business settings.', 'NORDBOOKING'),
                'error_loading' => __('Error loading business settings.', 'NORDBOOKING'),
                'error_ajax' => __('An AJAX error occurred.', 'NORDBOOKING'),
                'invalid_json' => __('Business Hours JSON is not valid.', 'NORDBOOKING'),
            ]
        ]);
        wp_localize_script('NORDBOOKING-dashboard-business-settings', 'nordbooking_biz_settings_params', $biz_settings_params);
    }
